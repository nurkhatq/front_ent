...
//   const [questions, setQuestions] = useState<any[]>([]); // Используем any для поддержки контекстных вопросов
...
//   const isContextQuestion = (question: any): boolean => {
//     return !!question.is_context_question;
//   };
  
//   // Функция для проверки, является ли вопрос с множественным выбором
//   const isMultipleChoiceQuestion = (question: any, index: number): boolean => {
...
//               setTestTitle('Пробный ЕНТ (Смешанный тест)');
//               setTestDescription('Комплексный тест со случайными вопросами из всех разделов');
...
//         const questionsWithNumbers = testData.questions.map((q, idx) => {
//           return { ...q, number: q.number || (idx + 1) };
//         });
//         setTestTitle(testData.title || 'Пробный ЕНТ (Смешанный тест)');
//         setTestDescription('Комплексный тест со случайными вопросами из всех разделов');
...
//           <p>Жүйеде пробный ЕНТ құру үшін жеткілікті сұрақтар жоқ.</p>
//         </Card>
//       </TestContainer>
//     );
//   }
